...
├── api/                    # Fetch API exercises folder
│   ├── api.html           # API exercises interface
│   └── api.js             # Fetch API exercises
├── async/                  # Async JavaScript exercises folder
...
1. **Async Exercises** - Open `async/async.html`, check console (F12)
2. **API Exercises** - Open `api/api.html`, practice with JSONPlaceholder API
